...
html_title = "PhantomQAMetrics v{}".format(__version__)

# A shorter title for the navigation bar.  Default is the same as html_title.
# html_short_title = 'PhantomQAMetrics v<release>'
...
htmlhelp_basename = "PhantomQAMetrics"
...
latex_documents = [
    (master_doc, "fileformats.tex", "PhantomQAMetrics Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "fileformats", "PhantomQAMetrics Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "PhantomQAMetrics",
        "PhantomQAMetrics Documentation",
        author,
        "PhantomQAMetrics",
