...
authors = [entry["name"] for entry in _pyproject["project"]["authors"]]
...
html_theme_options = {
    "light_css_variables": {
        "color-brand-primary": "#6b2d8b",
        "color-brand-content": "#6b2d8b",
    },
    "dark_css_variables": {
...
html_title = "PhantomKit v{}".format(__version__)

# A shorter title for the navigation bar.  Default is the same as html_title.
# html_short_title = 'PhantomKit v<release>'

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = "_static/logo_mark.svg"
...
latex_documents = [
    (master_doc, "phantomkit.tex", "PhantomKit Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "phantomkit", "PhantomKit Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "PhantomKit",
        "PhantomKit Documentation",
        author,
        "PhantomKit",
        "Automated QA of medical imaging scanners using physical phantoms.",
        "Miscellaneous",
    ),
]
