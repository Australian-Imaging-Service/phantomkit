...
class PhantomProcessor:
    ...
    def _check_registration(self, warped_image: str) -> bool:
        ...
        if failures:
            ...
            if high_std_vials:
                print("    Note: No high-std vials detected")
            return True
...
@python.define
def ProcessPhantomSession(
    input_image: str, template_dir: str, output_dir: str, rotation_lib: str
) -> dict:
...
def BatchWorkflow(
    ...
    process_session = workflow.add(
        ProcessPhantomSession(
    ...
    return process_session.results
